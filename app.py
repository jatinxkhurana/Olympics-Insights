...
st.sidebar.title("Olympic Analysis By Rohit")
...
if user_menu == 'Medal Tally':
    ...
    if selected_year == 'Overall' and selected_country == 'Overall':
        st.title("Overall Standings(or Tally)")
    if selected_year != 'Overall' and selected_country == 'Overall':
        st.title("Overall Standings(or Tally) in " + str(selected_year) + " Olympics")
    if selected_year == 'Overall' and selected_country != 'Overall':
        st.title("Performance of " + selected_country + " in all Olympics")
    if selected_year != 'Overall' and selected_country != 'Overall':
...
if user_menu == 'Country-wise Analysis':
    ...
    st.title(selected_country + "  over the years in following Sports")
